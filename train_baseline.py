...
class Trainer(object):
    ...
    def adjust_lr2(self, base_lr, iter, max_iter, power):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader, 1):
            ...
            if self.args.aux:
                task_loss = self.criterion(
                    outputs[0], targets) + 0.4 * self.criterion(outputs[1], targets)
            else:
            ...
            if iteration % log_per_iters == 0:
                ...
                if is_main_process():
                    task_loss_smooth = train_info_smooth.pop('loss_task')
                    ...
                    self.logger.info(
                        ...
                        f"|| Task Loss: {task_loss_smooth:.4f} "
...
if __name__ == '__main__':
    ...
    args.experiment_name = f'{args.dataset}_{args.model}-{args.backbone}_baseline'
    ...
    if is_main_process():
        ...
        wandb_tags = [args.dataset, f'{args.model}-{args.backbone}','baseline']
